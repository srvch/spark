...
class _SocialScreenState extends ConsumerState<SocialScreen> {
  ...
  List<FriendUser> _filteredFriends(List<FriendUser> friends) {
    ...
    if (_friendQuery.isNotEmpty) {
      ...
      list = list.where((f) =>
          f.displayName.toLowerCase().contains(q) || f.phoneNumber.contains(q)).toList();
    }
              ...
              child: AnimatedSwitcher(
                ...
                child: _tab == 0
                    ? _FriendsTab(
                        ...
                        onQueryChanged: (v) => setState(() => _friendQuery = v),
                        onSortChanged: (s) {
                          HapticFeedback.lightImpact();
                        ...
                        onCancelOutgoing: (r) {
                          HapticFeedback.lightImpact();
                          ref.read(socialControllerProvider).cancelFriendRequest(
                                requestId: r.requestId);
                        },
                        onAddSuggestion: (s) {
                          HapticFeedback.lightImpact();
                        ...
                        onToggleAvailability: () {
                          ...
                          ref.read(socialControllerProvider).setAvailability(
                    ...
                    : _GroupsTab(
                        ...
                        onQueryChanged: (v) => setState(() => _groupQuery = v),
                        onSortChanged: (s) {
                          HapticFeedback.lightImpact();
                        ...
                        onArchiveGroup: (g) {
                          HapticFeedback.mediumImpact();
                          ref.read(socialControllerProvider).archiveGroup(groupId: g.groupId);
                        },
                      ),
              ),
            ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Enter their phone number to send a request.',
                ...
                _IosButton(
                  ...
                  onTap: sending ? null : () async {
                    ...
                    try {
                      await ref.read(socialControllerProvider).sendFriendRequest(
                            v,
            ...
            onPressed: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => QrCodeScreen(
                    userId: friend.userId, name: friend.displayName),
              ));
            },
        ...
        actions: [
          CupertinoActionSheetAction(
            ...
            onPressed: () async {
              ...
              HapticFeedback.mediumImpact();
              try {
                await ref.read(socialControllerProvider).blockUser(userId: friend.userId);
                if (!mounted) return;
...
class _FriendsTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isFirstTime = allFriends.isEmpty &&
    ...
    if (isFirstTime) {
      return _OnboardingEmpty(onAddFriend: onAddFriend, onImport: onImportContacts);
    }
      ...
      child: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _WhosFreeBanner(
                myAvailability: myAvailability,
                availableFriends: allFriends.where((f) => f.isAvailable).toList(),
          ...
          if (friendRequests.isNotEmpty) ...[
            _sectionHeader('${friendRequests.length} PENDING REQUEST${friendRequests.length > 1 ? 'S' : ''}'),
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              sliver: SliverList(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text('Find friends from contacts',
                            style: TextStyle(
                                fontSize: 15,
      ...
      child: CustomScrollView(
        slivers: [
          ...
          if (groupInvites.isNotEmpty) ...[
            _sectionHeader('${groupInvites.length} GROUP INVITE${groupInvites.length > 1 ? 'S' : ''}'),
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                    ...
                    return Dismissible(
                      ...
                      background: Container(
                        ...
                        child: const Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(CupertinoIcons.archivebox, color: Colors.white, size: 22),
                            SizedBox(height: 3),
                            Text('Archive',
                                style: TextStyle(
                                    color: Colors.white,
              ...
              children: [
                for (int i = 0; i < availableFriends.length.clamp(0, 5); i++)
                  Padding(
                    ...
                    child: PersonAvatar(
                        name: availableFriends[i].displayName, radius: 14),
                  ),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    ...
                    style: const TextStyle(fontSize: 13, color: Color(0xFF34C759), fontWeight: FontWeight.w500),
                  ),
                ),
              ],
            ),
        ...
        children: [
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  const Icon(CupertinoIcons.clock, size: 16, color: Color(0xFF8E8E93)),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(requests[i].displayName,
                              style: const TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                                  color: Color(0xFF000000),
                                  fontFamily: 'Manrope')),
                          Text(requests[i].phoneNumber,
                              style: const TextStyle(
          ...
          children: [
            ...
            _OnboardingStep(
              ...
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => const QrCodeScreen(userId: 'me', name: 'My Profile'),
              )),
              cta: 'My QR code',
            ),
          ],
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) => ListView(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          _SkeletonCard(height: 14, width: 80, opacity: _anim.value, margin: const EdgeInsets.only(left: 4, bottom: 6)),
          for (int i = 0; i < 5; i++)
            _SkeletonCard(
              height: 56,
              opacity: _anim.value,
            ...
            ? const Center(
                child: SizedBox(
                  ...
                  child: CircularProgressIndicator(
                      strokeWidth: 1.8, color: Color(0xFF8E8E93)),
                ),
              )
    ...
    return SizedBox(
      ...
      child: CupertinoButton(
        ...
        child: Container(
          height: 50,
          decoration: BoxDecoration(
            color: secondary ? const Color(0xFFF2F2F7) : AppColors.accent,
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(message,
                style: const TextStyle(
                    color: Color(0xFFFF3B30), fontSize: 13.5)),
          ),
          CupertinoButton(
            padding: EdgeInsets.zero,
            minimumSize: 0,
